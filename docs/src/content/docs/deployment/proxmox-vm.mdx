...
The compose file publishes `8443` plus `9162/udp` (SNMP traps), `2023` (ESPA), `8123` (ESPA-X) and `4573` (FastAGI) — all on the private bridge only. Those four mappings were merged on 2026-08-23 (branch `feature/signup-flag-var`); before that, event sources listening on them inside the container were unreachable from the lab network.
:::
