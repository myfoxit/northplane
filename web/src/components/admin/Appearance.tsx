...
// see it both ways. Both are per-browser preferences (localStorage): mode
// toggles <html class="light"> (mode.ts), theme toggles <html data-theme>
// (theme.ts). See the :root / :root.light blocks in index.css.
